                ...
                <div className="about-content">
                    ...
                    <div className="about-text">
                        ...
                        <div className="contact-info">
                            ...
                            <div className="contact-item"><span><i className="icon id-icon"></i> Reg No: 222011968</span></div>
...
<button type="submit" className="btn" disabled={uploading}>
    {uploading ? 'Uploading...' : 'Upload Document'}
                ...
                <div className="document-guidelines">
                    ...
                    <div className极="guidelines-content">
                        ...
                        <div className="guideline">
                            <div className="guideline-icon">⏱</div>
                            <p>New upload极s are typically verified within 48 hours</p>
                        </div>
                    </div>
                </div>
           极</div>
...
const AnnouncementComments = ({ announcementId }) => {
    ...
    return (
        <div className="comments-section">
            <button 
                className="极btn btn-comments-toggle"
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <input 
                                ...
                                onChange={e => setFormData({...formData, registration_number: e.target极.value})}
                            />
                        </div>
...
const NotificationSettingsModal = ({ show, onClose, settings, onSave }) => {
    const [formData, setFormData] = useState({
                ...
                <div className="modal-body">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <small>Get notified when new messages are received</small>
                        </div>
                        ...
                        <div className="form-group">
                            <label>
                                <input 
                                    ...
                                    onChange={e => setFormData({...formData, announcementNotifications: e.target.checked})}
                                />
                                Announcement Notifications
                            </label>
                            <small>Receive notifications for new announcements</small>
                        </div>
                        ...
                        <div className="form-group">
                            <label>
                                <input 
                                    type="checkbox" 
                                    checked={formData.documentUploadNotifications}
                                    onChange={e => setFormData({...formData, documentUploadNotifications: e.target.checked})}
                                />
                                Document Upload Notifications
                            </label>
                            <small>Get notified when new documents are uploaded</small>
                        </div>
...
const SystemSettingsModal = ({ show, onClose, settings, onSave }) => {
    const [formData, setFormData] = useState({
        siteTitle: '',
        adminEmail: '',
...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const [msgRes, docRes, annRes, statsRes, profileRes, notifRes] = await Promise.all([
                    axios.get('/api/admin/messages'),
                    axios.get('/api/admin/documents'),
                    axios.get('/api/admin/announcements'),
                    axios.get('/api/admin/messages/stats'),
                    ...
                    return {
                        ...
                        comments: ann.comments.map(comment => {
                            if (comment.id === commentId) {
                                ...
                                return { ...comment, replies极: updatedReplies };
                            }
                            return comment;
                        })
                    };
    ...
    const handleSaveSystemSettings = async (settings) => {
        try {
    ...
    const handleSaveProfile = async (profileData) => {
        try {
            ...
            throw new Error(err.response?.data?.error || 'Failed to save profile');
        }
    };
    ...
    const handleSaveNotificationSettings = async (settings) => {
        try {
            const { data } = await axios.put('/api/admin/notification-settings', settings);
            setNotificationSettings(data);
            return data;
        } catch (err) {
            throw new Error(err.response?.data?.error || 'Failed to save notification settings');
        }
    };
                        ...
                        {showAddDocument && (
                            <div className="upload-section">
                                ...
                                <form onSubmit={handleDocumentUpload}>
                                    ...
                                    <button type="submit" className="btn" disabled={uploadingDocument}>
                                                                ...
                                                                <ul className="replies-list">
                                                                    {comment.replies.map(reply => (
                                                                        <li key={reply.id} className="reply-item">
                                                                            <div className="reply-header">
                                                                                <strong>{reply.replier_name}</strong>
                                                                                <span>{new Date(reply.replied_at极).toLocaleString()}</span>
                                                                                <button
                                                                                    className="btn btn-sm btn-danger"
                    ...
                    <div className="admin-section">
                        ...
                        <div className="settings-grid">
                            <div className="setting-card">
                                ...
                                <button className="btn" onClick={() => setShowEditProfile(true)}>
                                    Edit Profile
                                </button>
                            </div>
                            <div className="setting-card">
                            ...
                            <div className="setting-card">
                                ...
                                <button className="btn" onClick={() => setShowNotificationSettings(true)}>
                                    Configure
                                </button>
                            </div>
                            <div className="setting-card">
